...
// Output path: override with `node scripts/convert_paper.js <out.docx>`;
// defaults to <skill-dir>/output.docx
const OUTPUT_PATH   = process.argv[2]
  ? path.resolve(process.argv[2])
  : path.resolve(__dirname, '..', 'output.docx');
// Example images live inside the skill directory: <skill-dir>/example/markdown论文/images
